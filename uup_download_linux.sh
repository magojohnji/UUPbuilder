...
aria2c --no-conf --console-log-level=warn --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=2e5be87c-a2d1-4164-b90a-17e003156729&pack=en-us&edition=professional&aria2=2"
if [ $? != 0 ]; then
